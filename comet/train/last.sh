...
# different models
#runlite run -exp base-v1-lmb2 -bc base -ov -sm $1 -var model_id=t5-base#t5-v1#t5-lmb--method=unsup-nat#sup-nat--rel_filter=xAttr#xIntent --train_samples=100  --test_samples=300 --repeat=3 --loop=True $extra --skip=True 
