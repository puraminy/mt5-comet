...
def extra_id_0(tokenizer):
    token = "<extra_id_0>"
    return get_extra_id(tokenizer, token)

def extra_id_1(tokenizer):
    token = "<extra_id_1>"
    return get_extra_id(tokenizer, token)

def get_extra_id(tokenizer, token):
    id = tokenize.convert_token_to_id(token)
    return id
