...
runlite run -exp $path -bc base -ov $g2 -var model_id=t5-large--method=unsup-wrap-nat--rel_filter=xIntent#xAttr#multi--train_samples=200--epochs_num=2--repeat=4--temp_num=64--loop=True--test_samples=100--merge_prompts=lstm#mlp --follow_method=True --scorers="rouge-bert" --data_path=${home}/mt5-comet/comet/data/atomic2020 --do_valid=False --val_samples=10 --encoder_type=lstm --cycle=100 $g1 --seed=123 --batch_size=8  
