...
runlite run -exp $path -bc base -ov $g1 -var model_id=t5-base--method=unsup-nat#unsup#unsup-wrap-nat--rel_filter=xIntent#xAttr#multi--train_samples=50--epochs_num=1--repeat=4--temp_num=6--loop=True--test_samples=100--skilled_variant=learned#hyper#sparse#shared#private --follow_method=True --scorers="rouge-bert" --data_path=/home/pouramini/mydata/atomic2020 --do_valid=False --val_samples=10 --encoder_type=lstml --cycle=100 $g2 --seed=123 --batch_size=2 
